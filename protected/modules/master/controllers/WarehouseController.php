...
class WarehouseController extends Controller
{
	...
	{	
		$stockcomponents=new StockComponents;
		$stockgoods=new StockGoods;
		$warehouse=Warehouse::model()->findByPk($id);
	
		$criteria=new CDbCriteria;
		$criterias=new CDbCriteria;
		$criteria->compare('warehouse_id',$id);
		$criterias->compare('warehouse_id',$id);

		$dataGb = new CActiveDataProvider('StockComponents', array(
			'criteria'=>$criteria,
		));
		$dataCb = new CActiveDataProvider('StockGoods', array(
			'criteria'=>$criterias,
		));
