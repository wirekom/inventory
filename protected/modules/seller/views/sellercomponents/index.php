...
Yii::app()->clientScript->registerScript('add-trans-seller-components', "
var no = 0;
$('.button_ok').click(function(){
if(document.getElementById('Components_component_name').value == '' || document.getElementById('sender_name').value == '' || document.getElementById('type_order').value == '' || document.getElementById('desc').value == ''){
	...
	$.ajax({
		...
		dataType : 'json',
		cache : false,
		url : '".Yii::app()->request->baseUrl."/index.php/seller/sellercomponents/addtrans',
		data : {
		...
		success : function(data){
			$('#box-table-a > tbody:last').append('<tr id=\"trans_'+no+'\"><td><input type=\"checkbox\" name=\"cek_'+no+'\"></td><td>'
	        		...
	        		'<input type=\"hidden\" name=\"SellerComponents['+no+'][component_id]\" value=\"'+data.component_id+'\">'+
	        		'<input type=\"hidden\" name=\"SellerComponents['+no+'][sender_name]\" value=\"'+document.getElementById('sender_name').value+'\">'+
	        		'<input type=\"hidden\" name=\"SellerComponents['+no+'][type_order]\" value=\"'+document.getElementById('type_order').value+'\">'+
	        		'<input type=\"hidden\" name=\"SellerComponents['+no+'][decsription]\" value=\"'+document.getElementById('desc').value+'\">'+
...
<!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Seller Components</h1>
    </div>
    <!--RIGHT TEXT/CALENDAR-->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
        <div class="portlet">
		<div class="portlet-header">Form Seller Components</div>
    ...
    <div class="portlet">
        <div class="portlet-header"><img src="<?php echo Yii::app()->request->baseUrl."/assets/default/"; ?>images/icons/user.gif" width="16" height="16" alt="Latest Registered Users" /> Table Seller Components</div>
		<div class="portlet-content">
