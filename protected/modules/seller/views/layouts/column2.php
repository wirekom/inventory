...
<!-- TABS START -->
    <div id="tabs">
		...
		$this->menu=array( 
			array('label'=>'<span>Seller Components</span>', 'url'=>array('/seller/sellercomponents/create'), 'linkOptions' => array('class'=>(strpos($ex,'/seller/sellercomponents/create'))?"current":"")),
			array('label'=>'<span>Seller Goods</span>', 'url'=>array('/seller/sellergoods/create'), 'linkOptions' => array('class'=>(strpos($ex,'/seller/sellergoods/create'))?"current":"")),
		);
