...
class SellercomponentsController extends Controller
{
	/**
	...
	{
		if(isset($_POST['SellerComponents']))
		{
			$err = 0;
			foreach($_POST['SellerComponents'] as $postrans){
				$model=new SellerComponents;
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['SellerComponents']))
		{
			$model->attributes=$_POST['SellerComponents'];
			if($model->save())
	...
	{
		$model=new SellerComponents('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SellerComponents']))
			$model->attributes=$_GET['SellerComponents'];
	...
	{
		$model=SellerComponents::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='seller-components-form')
		{
