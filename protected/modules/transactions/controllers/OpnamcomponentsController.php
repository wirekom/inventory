...
class OpnamcomponentsController extends Controller
{
	/**
		...
		public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','cekcomponents','addtrans'),
				'users'=>array('*'),
			),
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['OpnamComponents']))
		{
			$model->attributes=$_POST['OpnamComponents'];
			if($model->save())
	...
	{
		$model=new OpnamComponents('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['OpnamComponents']))
			$model->attributes=$_GET['OpnamComponents'];
	...
	{
		$model=OpnamComponents::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='opnam-components-form')
		{
