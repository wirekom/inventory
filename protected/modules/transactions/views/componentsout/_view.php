<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('warehouse_from')); ?>:</b>
	<?php echo CHtml::encode($data->warehouse_from); ?>
	<br />
	
	<b><?php echo CHtml::encode($data->getAttributeLabel('warehouse_to')); ?>:</b>
	<?php echo CHtml::encode($data->warehouse_to); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('goods_t_id')); ?>:</b>
	<?php echo CHtml::encode($data->goods_t_id); ?>
	<br />
