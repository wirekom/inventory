...
Yii::app()->clientScript->registerScript('add-trans-goods-out', "
var no = 0;
$('.button_ok').click(function(){
if(document.getElementById('Goods_goods_name').value == '' || document.getElementById('order_name').value == '' || document.getElementById('warehouse_from').value == '' || document.getElementById('warehouse_to').value == '' || document.getElementById('qty').value == '' || document.getElementById('desc').value == ''){
	...
	$.ajax({
		...
		success : function(data){
			$('#box-table-a > tbody:last').append('<tr id=\"trans_'+no+'\"><td><input type=\"checkbox\" name=\"cek_'+no+'\"></td><td>'
	        		...
	        		'</td><td>'
	        		+document.getElementById('order_name').options[document.getElementById('order_name').selectedIndex].text+
	        		'</td><td>'
	        		...
	        		'<input type=\"hidden\" name=\"GoodsTransaction['+no+'][warehouse_from]\" value=\"'+document.getElementById('warehouse_from').value+'\">'+
	        		'<input type=\"hidden\" name=\"GoodsTransaction['+no+'][warehouse_to]\" value=\"'+document.getElementById('warehouse_to').value+'\">'+
...
<!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Goods Mutation</h1>
    </div>
    <!--RIGHT TEXT/CALENDAR-->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
        <div class="portlet">
		<div class="portlet-header">Form Goods Mutation</div>
    ...
    <div class="portlet">
        <div class="portlet-header"><img src="<?php echo Yii::app()->request->baseUrl."/assets/default/"; ?>images/icons/user.gif" width="16" height="16" alt="Latest Registered Users" /> Table List Goods Mutation</div>
		<div class="portlet-content">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
            <thead>
              <tr>
                ...
                <th width="11%" scope="col">warehouse From</th>
                <th width="11%" scope="col">warehouse To</th>
