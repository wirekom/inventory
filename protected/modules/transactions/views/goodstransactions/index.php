...
if(document.getElementById('Goods_goods_name').value == '' || document.getElementById('order_name').value == '' || document.getElementById('warehouse_from').value == '' || document.getElementById('qty').value == '' || document.getElementById('desc').value == ''){
...
<!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Incoming Goods</h1>
    </div>
    <!--RIGHT TEXT/CALENDAR-->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
        <div class="portlet">
		<div class="portlet-header">Form Incoming Goods</div>
    ...
    <div class="portlet">
        <div class="portlet-header"><img src="<?php echo Yii::app()->request->baseUrl."/assets/default/"; ?>images/icons/user.gif" width="16" height="16" alt="Latest Registered Users" /> Table List Incoming Goods</div>
		<div class="portlet-content">
